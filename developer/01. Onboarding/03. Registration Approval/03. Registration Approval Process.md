...
###### Step 1 - Register self description
...
To fetch the specific checklist process step details; status; possible available comment as well as the re-triggerable status, the following endpoint needs to get called
<br>
